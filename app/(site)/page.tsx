...
import { getBestsellers, getReviews, getSiteImages, getFeaturedWorks, getCategoryImageMap } from "@/lib/catalog";
...
export default async function HomePage() {
  const [products, reviews, images, works, catImg] = await Promise.all([
    getBestsellers(),
    getReviews(),
    getSiteImages(),
    getFeaturedWorks(),
